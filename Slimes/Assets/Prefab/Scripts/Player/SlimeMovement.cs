...
public class SlimeMovement : MonoBehaviour
{
    ...
    //the rigidbody used to move the player (necessary for this componen, so not made public)
    ...
    // the jump collected from the input manager
    ...
    public TeleportPlayer teleportCheck = null;
    public bool teleport
    {
        get
        {
            ...
            {
                Debug.Log("meow");
                return teleportCheck.areYouTeleporting();
            }
            else
            {
                return false;
